        ...
        html.Div(
            ...
            html.Div(
                ...
                dcc.Dropdown(
                    ...
                    value=horas[list(dict(itertools.islice(horas.items(), dt.datetime.now().hour)).keys())[-1]],
                )
...
def display_stores_over_time(time, variable):
